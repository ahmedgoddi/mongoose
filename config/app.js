...
const samplePerson = new Person({name: "Sample Person", age: 27, favoriteFoods: ["chicken", "water"]});
...
// 'arrayOfPeople'.
const arrayOfPeople = [
    {name: "samir", age: 24, favoriteFoods: ["mar9a"]},
    {name: "sadek", age: 21, favoriteFoods: ["makrouna"]},
    {name: "sankouh", age: 27, favoriteFoods: ["pizza"]}
];
